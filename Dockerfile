...
RUN git clone https://github.com/juusosar/ProjectX2.0

WORKDIR /ProjectX/ProjectX2.0
RUN ls -a

RUN sh -c cifuzz run test1 > /ProjectX/ProjectX2.0/fuzzing.log 2>&1 && cat /ProjectX/ProjectX2.0/fuzzing.log
